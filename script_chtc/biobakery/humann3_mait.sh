...
mv $1_R1_trimmed_paired_mouseDNAremoved.fastq $2.fastq
...
humann --input $2.fastq --output humann3_out_$2 --nucleotide-database ./humann3_db/chocophlan --protein-database ./humann3_db/uniref --metaphlan-options "--bowtie2db ./metaphlan_bowtie2db --index mpa_v30_CHOCOPhlAn_201901" --threads 16 
